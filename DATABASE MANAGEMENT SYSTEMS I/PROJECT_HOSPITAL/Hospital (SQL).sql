...
insert into Patient (Patient_id, first_name, middle_name, last_name, gender, Phone, address, DOB, EMC_P_name) values (1, 'Roseanne', 'Stormie', 'Glasbey', 'F', '364-580-1483', '442 Surrey Pass', '1984-12-5', 'Leaa');
insert into Patient (Patient_id, first_name, middle_name, last_name, gender, Phone, address, DOB, EMC_P_name) values (2, 'Ber', 'Padget', 'Magenny', 'M', '485-232-8173', '124 Shoshone Terrace', '1984-4-10', 'Bob');
insert into Patient (Patient_id, first_name, middle_name, last_name, gender, Phone, address, DOB, EMC_P_name) values (3, 'Parrnell', 'Alanson', 'Lant', 'M', '584-375-4929', '5858 Sheridan Trail', '1984-10-1', 'Valerie');
insert into Patient (Patient_id, first_name, middle_name, last_name, gender, Phone, address, DOB, EMC_P_name) values (4, 'Giorgia', 'Cindee', 'Cruden', 'F', '411-265-4000', '25 Fordem Point', '1984-7-17', 'Grace');
insert into Patient (Patient_id, first_name, middle_name, last_name, gender, Phone, address, DOB, EMC_P_name) values (5, 'Konstance', 'Bonny', 'Stot', 'F', '111-441-0082', '62 Northview Hill', '1982-4-1', 'dan');
